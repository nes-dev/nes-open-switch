 ...
 */
#define NEMPLSTUNNELHOPLABELTYPE 1
#define NEMPLSTUNNELHOPFORWARDLABEL 2
#define NEMPLSTUNNELHOPREVERSELABEL 3
 ...
 */
#define NEMPLSTUNNELCHOPLABELTYPE 1
#define NEMPLSTUNNELCHOPFORWARDLABEL 2
#define NEMPLSTUNNELCHOPREVERSELABEL 3
...
/**
 *	table neMplsCallLinkDescriptorTable definitions
 */
#define NEMPLSCALLLINKDESCRIPTORSWITCHINGCAPABILITY 1
#define NEMPLSCALLLINKDESCRIPTORENCODINGTYPE 2
#define NEMPLSCALLLINKDESCRIPTORMINLSPBANDWIDTH 3
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO0 4
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO1 5
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO2 6
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO3 7
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO4 8
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO5 9
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO6 10
#define NEMPLSCALLLINKDESCRIPTORMAXLSPBANDWIDTHPRIO7 11
#define NEMPLSCALLLINKDESCRIPTORINTERFACEMTU 12
#define NEMPLSCALLLINKDESCRIPTORINDICATION 13

enum
{
	/* enums for column neMplsCallLinkDescriptorSwitchingCapability */
	neMplsCallLinkDescriptorSwitchingCapability_unknown_c = 0,
	neMplsCallLinkDescriptorSwitchingCapability_psc1_c = 1,
	neMplsCallLinkDescriptorSwitchingCapability_psc2_c = 2,
	neMplsCallLinkDescriptorSwitchingCapability_psc3_c = 3,
	neMplsCallLinkDescriptorSwitchingCapability_psc4_c = 4,
	neMplsCallLinkDescriptorSwitchingCapability_evpl_c = 30,
	neMplsCallLinkDescriptorSwitchingCapability_pbb_c = 40,
	neMplsCallLinkDescriptorSwitchingCapability_l2sc_c = 51,
	neMplsCallLinkDescriptorSwitchingCapability_tdm_c = 100,
	neMplsCallLinkDescriptorSwitchingCapability_otntdm_c = 110,
	neMplsCallLinkDescriptorSwitchingCapability_dcsc_c = 125,
	neMplsCallLinkDescriptorSwitchingCapability_lsc_c = 150,
	neMplsCallLinkDescriptorSwitchingCapability_fsc_c = 200,

	/* enums for column neMplsCallLinkDescriptorEncodingType */
	neMplsCallLinkDescriptorEncodingType_tunnelLspNotGmpls_c = 0,
	neMplsCallLinkDescriptorEncodingType_tunnelLspPacket_c = 1,
	neMplsCallLinkDescriptorEncodingType_tunnelLspEthernet_c = 2,
	neMplsCallLinkDescriptorEncodingType_tunnelLspAnsiEtsiPdh_c = 3,
	neMplsCallLinkDescriptorEncodingType_tunnelLspSdhSonet_c = 5,
	neMplsCallLinkDescriptorEncodingType_tunnelLspDigitalWrapper_c = 7,
	neMplsCallLinkDescriptorEncodingType_tunnelLspLambda_c = 8,
	neMplsCallLinkDescriptorEncodingType_tunnelLspFiber_c = 9,
	neMplsCallLinkDescriptorEncodingType_tunnelLspFiberChannel_c = 11,
	neMplsCallLinkDescriptorEncodingType_tunnelDigitalPath_c = 12,
	neMplsCallLinkDescriptorEncodingType_tunnelOpticalChannel_c = 13,
	neMplsCallLinkDescriptorEncodingType_tunnelLine_c = 14,

	/* enums for column neMplsCallLinkDescriptorIndication */
	neMplsCallLinkDescriptorIndication_standard_c = 0,
	neMplsCallLinkDescriptorIndication_arbitrary_c = 1,
};

/* table neMplsCallLinkDescriptorTable row entry data structure */
typedef struct neMplsCallLinkDescriptorEntry_t
{
	/* Index values */
	uint32_t u32IngressLsrId;
	uint32_t u32EgressLsrId;
...
extern xBTree_t oNeMplsCallLinkDescriptorTable_BTree;

/* neMplsCallLinkDescriptorTable table mapper */
void neMplsCallLinkDescriptorTable_init (void);
neMplsCallLinkDescriptorEntry_t * neMplsCallLinkDescriptorTable_createEntry (
	uint32_t u32IngressLsrId,
	uint32_t u32EgressLsrId,
	uint32_t u32Id,
	uint32_t u32LinkIndex);
neMplsCallLinkDescriptorEntry_t * neMplsCallLinkDescriptorTable_getByIndex (
	uint32_t u32IngressLsrId,
	uint32_t u32EgressLsrId,
	uint32_t u32Id,
	uint32_t u32LinkIndex);
neMplsCallLinkDescriptorEntry_t * neMplsCallLinkDescriptorTable_getNextIndex (
	uint32_t u32IngressLsrId,
	uint32_t u32EgressLsrId,
	uint32_t u32Id,
	uint32_t u32LinkIndex);
void neMplsCallLinkDescriptorTable_removeEntry (neMplsCallLinkDescriptorEntry_t *poEntry);
#ifdef SNMP_SRC
Netsnmp_First_Data_Point neMplsCallLinkDescriptorTable_getFirst;
Netsnmp_Next_Data_Point neMplsCallLinkDescriptorTable_getNext;
Netsnmp_Get_Data_Point neMplsCallLinkDescriptorTable_get;
Netsnmp_Node_Handler neMplsCallLinkDescriptorTable_mapper;
#endif	/* SNMP_SRC */
